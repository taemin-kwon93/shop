...
<table width="960" cellspacing="0" cellpadding="0" border="0" align="center">
	...
	<td colspan=2>
	<!-- 회원가입 -->
	<form name="joinform" id="joinform" action="./MemberJoinAction.me" method="post" onsubmit="return check()">		
	<%--form태그에서 id속성은 자바스크립트 구문에서 폼태그 데이터를 사용할때 쓰이고
		name속성은 submit 전송시에 사용된다. name속성을 지정하지 않았을때, 중복확인 닫기 버튼이 눌리지 않음.--%>
	<p align="center">	
