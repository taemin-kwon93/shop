...
<table width="960" cellspacing="0" cellpadding="0" border="0" align="center">
	<tr>
		...
		<form action="./AdminOrderModify.ao" name="orderform" method="post">
			...
			size=15 maxlenght=20
			value=<%if(order.getORDER_TRANS_NUM()!=null){ %>
			<%= order.getORDER_TRANS_NUM() %> <%} %>></td>
		</tr>
		<tr>
			<td style="font-family:Tahoma;font-size:8pt; font-weight:bold;"	width=130 height=24 bgcolor="f7f7f7">
			주문번호</td>
			<td style="font-family:Tahoma;font-size:8pt;font-weight:bold;">
		...
		<tr height=20>
			<td style="font-family:Tahoma; font-size:8pt; font-weight:bold;" width=130 height=24 bgcolor="f7f7f7" colspan=2>
			상품정보</td>
		</tr>
		<tr>
			<td style="background-color:F0F0F0; height:1px;" colspan=6>
		...
		<tr>
			<td style="background-color:F0F0F0; font-size:8pt;" width=130 height=24 bgcolor="f7f7f7">수량</td>
			<td style="font-family:Tahoma;font=size:8pt;"><%=order.getORDER_GOODS_AMOUNT() %>
			</td>
		</tr>
		<tr>
			<td style="background-color:F0F0F0; height: 1px;" colspan=6>
		...
		<tr height=20>
			<td style="font-family:Tahoma;font-size:8tp;" width=130 height=24 bgcolor="f7f7f7">사이즈</td>
			<td style="font-family:Tahoma;font-size:8tp;"><%=order.getORDER_GOODS_SIZE() %>
			</td>
		</tr>
		<tr>
			<td style="background-color:#F0F0F0; height:1px;" colspan=6>
		...
		<tr height=20>
			<td style="font-family:Tahoma; font-size:8pt;" width=130 height=24 bgcolor="f7f7f7">색깔</td>
			<td style="font-family:Tahoma; font-size:8pt;"><%=order.getORDER_GOODS_COLOR() %>
			</td>
		</tr>
		<tr>
			<td style="font-family:Tahoma;font-size:8pt; font-weight:bold;" width=130 height=24 bgcolor="f7f7f7" colspan=2>
...
<table width=80% border=0 cellpadding="0" cellspacing="1">
	...
	<tr>
		<td style="bacoground-color:#F0F0F0;height:1px;" colspan=6>
	</tr>
	<tr>
		<td style="font-family:Tahoma; font-size:8pt;" width=200 height=24
			bgcolor="f7f7f7">결제 방법:</td>
		<td width=320 height=24>
	...
	<tr>
		<td style="font-family:Tahoma; font-size:8pt;" width=200 height=24 bgcolor="f7f7f7">주문상태:</td>
		<td width=320 height=24>
		<select name="status">
